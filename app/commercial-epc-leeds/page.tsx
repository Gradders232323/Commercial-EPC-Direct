...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Commercial EPC Leeds | Local Commercial EPC Assessors", description: "Commercial energy assessments across Leeds and West Yorkshire.", url: "https://www.commercialepcdirect.co.uk/commercial-epc-leeds", images: [{ url: "", width: 1731, height: 909, alt: "Commercial EPC Direct" }] },
  twitter: { card: "summary_large_image", images: ["https://www.commercialepcdirect.co.uk/og.png"] },
};

const propertyTypes = ["Offices and office buildings", "Retail shops and parade units", "Warehouses", "Industrial units", "Workshops", "Business units", "Restaurants and ", "Pubs and hospitality premises", "Storage facilities", "Trade counters", "Mixed-use developments", "Larger commercial buildings"];
...
const sectorDetails = [
  ...
  { number: "02", title: "Shops and retail", copy: "Assessments for high-street shops, retail units, showrooms, restaurants,  and other customer-facing premises across central Leeds and suburban commercial centres.", items: ["High-street shops", "Retail units", "Showrooms", "Restaurants and cafÃ©s"] },
    ...
    <main className="location-page leeds-page">
      ...
      <section className="location-hero" id="top">
        <div className="location-hero-copy">
          ...
          <div className="hero-actions"><a className="button" href="#leeds-top-enquiry">Get your Leeds EPC quote <span></span></a><a className="text-link" href="#leeds-services">View the service <span>â</span></a></div>
      ...
      <section className="assessment-section">
        <div className="assessment-heading"><span className="kicker light">Commercial EPC assessors in Leeds</span><h2>A thorough inspection, completed correctly.</h2><p>The assessor gathers the information needed to model the buildings energy performance using the approved commercial EPC methodology.</p></div>
        ...
        <p className="method-note">The scope and price depend on the buildings size, construction, services and complexity. Send us the property details for an accurate quotation.</p>
      </section>
      ...
      <section className="section leeds-compliance-section">
        ...
        <div className="leeds-compliance-grid">
          ...
          <article><span>02</span><h3>How long does it last?</h3><p>A Commercial EPC is normally valid for 10 years, or until it is replaced by a newer certificate. Existing certificates can be checked on the official government register.</p><a href="https://www.gov.uk/find-energy-certificate" target="_blank" rel="noreferrer">Check the EPC register </a></article>
      ...
      <section className="quote-section york-quote" id="leeds-quote">
        <div className="quote-copy"><span className="kicker">Get a Commercial EPC quote in Leeds</span><h2>Tell us about your property.</h2><p>Send the address, approximate floor area and property type, and well prepare a quotation for the assessment.</p><div className="quote-promise"><span></span><div><strong>Accurate quotation</strong><p>Based on the property and scope.</p></div></div><div className="quote-promise"><span></span><div><strong>Professional support</strong><p>For straightforward and complex buildings.</p></div></div></div>
        <QuoteForm {...leedsFormIntegration} postcodePlaceholder="e.g. LS1 4AP" sourceLabel="Commercial EPC Leeds  bottom form" />
      </section>
      <section className="section faq" id="leeds-faq">
        ...
        <div className="faq-list">
          ...
          <details><summary>How much does a Commercial EPC cost in Leeds?<span>+</span></summary><p>The price depends on the buildings size, layout, services and complexity. Send us the address and basic property information for a tailored quote.</p></details>
          ...
          <details><summary>Do you cover areas outside Leeds?<span>+</span></summary><p>Yes. Coverage is available across West Yorkshire and beyond. Send the postcode and well confirm availability.</p></details>
        </div>
      </section>
      <footer>
