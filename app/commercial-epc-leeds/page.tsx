...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Commercial EPC Leeds | Local Commercial EPC Assessors", description: "Commercial energy assessments across Leeds and West Yorkshire.", url: "https://commercialepcleeds.co.uk", images: [{ url: "https://commercialepcleeds.co.uk/og.png", width: 1731, height: 909, alt: "Commercial EPC Leeds" }] },
  twitter: { card: "summary_large_image", images: ["https://commercialepcleeds.co.uk/og.png"] },
};

const propertyTypes = ["Offices and office buildings", "Retail shops and parade units", "Warehouses", "Industrial units", "Workshops", "Business units", "Restaurants and cafés", "Pubs and hospitality premises", "Storage facilities", "Trade counters", "Mixed-use developments", "Larger commercial buildings"];
...
const sectorDetails = [
  ...
  { number: "02", title: "Shops and retail", copy: "Assessments for high-street shops, retail units, showrooms, restaurants, cafés and other customer-facing premises across central Leeds and suburban commercial centres.", items: ["High-street shops", "Retail units", "Showrooms", "Restaurants and cafés"] },
  ...
  return (
    <main className="location-page leeds-page">
      ...
      <section className="quote-section enquiry-placement top-enquiry" id="leeds-top-enquiry">
        ...
        <QuoteForm {...leedsFormIntegration} postcodePlaceholder="e.g. LS1 4AP" formLabel="Leeds property details" buttonLabel="Get my EPC quote" sourceLabel="Commercial EPC Leeds — top form" />
      </section>
