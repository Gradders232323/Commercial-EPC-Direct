  ...
  return (
    <main className="location-page">
      ...
      <footer>
        ...
        <div className="footer-links"><a href="/">Home</a><a href="#services">Services</a><a href="#york-faq">Guides</a><a href="/about">About</a><a href="/locations">Locations</a><a href="#york-quote">Get a quote</a></div>
        <SocialLinks />
