        ...
        {filtered.map((region, regionIndex) => (
          <section className="directory-region" id={region.slug} key={region.slug}>
            ...
            <div className="city-grid">{region.cities.map(city => {
              const liveHref = city === "York" ? "/commercial-epc-york" : city === "Leeds" ? "/commercial-epc-leeds" : city === "Manchester" ? "/commercial-epc-manchester" : city === "Birmingham" ? "/commercial-epc-birmingham" : city === "London" ? "/commercial-epc-london" : null;
