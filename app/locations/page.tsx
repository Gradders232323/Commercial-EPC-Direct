...
export default function LocationsPage() {
  return (
    <main className="locations-page">
      ...
      <footer><a className="brand brand-footer" href="/"><span className="brand-mark" aria-hidden="true"><i></i><i></i><i></i></span><span>Commercial EPC <b>Direct</b></span></a><p>Commercial energy assessments, made simple.</p><div className="footer-links"><a href="/#services">Services</a><a href="/#faq">Guides</a><a href="/about">About</a><a href="/locations">Locations</a><a href="#locations-enquiry">Get a quote</a></div><SocialLinks /><small>© {new Date().getFullYear()} Commercial EPC Direct. All rights reserved.</small></footer>
    </main>
  );
}
