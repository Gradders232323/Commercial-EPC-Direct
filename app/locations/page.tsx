  ...
  return (
    <main className="locations-page">
      ...
      <section className="locations-hero">
        <div><div className="eyebrow"><span></span> Nationwide commercial EPC coverage</div><h1>In-house assessors.<br/><em>One direct service.</em></h1><p>Find commercial EPC coverage in your area, browse by region or send us the postcode. Every assessment is delivered by our own accredited team—not a freelance network.</p><a className="button" href="#find-location">Find your location <span>↓</span></a></div>
        <div className="coverage-card" aria-hidden="true"><div className="coverage-top"><span>UK IN-HOUSE TEAM</span><i></i></div><strong>12</strong><p>regions covered</p><div className="coverage-lines"><i></i><i></i><i></i><i></i><i></i></div><small>Commercial EPCs for offices, retail, industrial and hospitality properties.</small></div>
      </section>
      ...
      <IndustryLogos />
      <LocationsDirectory />
      <section className="quote-section locations-quote" id="locations-enquiry"><div className="quote-copy"><span className="kicker">Can’t find your location?</span><h2>Send us the postcode.</h2><p>We work nationwide. Share the property details and we’ll confirm our in-house team’s coverage, availability and a clear quotation.</p><div className="quote-promise"><span>✓</span><div><strong>In-house assessors</strong><p>Our own accredited specialists.</p></div></div><div className="quote-promise"><span>✓</span><div><strong>One helpful team</strong><p>From enquiry to certificate.</p></div></div></div><QuoteForm postcodePlaceholder="Enter the property postcode" formLabel="Location enquiry" buttonLabel="Check coverage" sourceLabel="Locations directory enquiry" /></section>
      <footer><a className="brand brand-footer" href="/"><span className="brand-mark" aria-hidden="true"><i></i><i></i><i></i></span><span>Commercial EPC <b>Direct</b></span></a><p>Commercial energy assessments, made simple.</p><div className="footer-links"><a href="/#services">Services</a><a href="/guides">Guides</a><a href="/about">About</a><a href="/locations">Locations</a><a href="#locations-enquiry">Get a quote</a></div><SocialLinks /><small>© {new Date().getFullYear()} Commercial EPC Direct. All rights reserved.</small></footer>
    </main>
  );
}
